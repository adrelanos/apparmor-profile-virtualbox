...
See [instructions](https://www.whonix.org/wiki/Dev/Build_Documentation/apparmor-profile-virtualbox). (Replace `package-name` with the actual name of this package.)
